...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    lateinit var landLatitude: EditText
    lateinit var landLongitude: EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        landLatitude = findViewById(R.id.etLatitude)
        landLongitude = findViewById(R.id.etLongitude)
